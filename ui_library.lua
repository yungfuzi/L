...
function Library:CreateWindow(info)
    ...
    function Window:AddTab(name)
        ...
        TabButton.BackgroundColor3 = self.Scheme.Inline
        TabButton.Text = name
        TabButton.TextColor3 = self.Scheme.FontColor
        ...
        Connect(Tab, TabButton.MouseButton1Click, function()
            for _, t in ipairs(self.Tabs) do
                Tween(t.Button, TweenInfo.new(0.15), {BackgroundColor3 = self.Scheme.Inline})
            end
            Tween(TabButton, TweenInfo.new(0.15), {BackgroundColor3 = self.Scheme.Accent})
            self.ActiveTab = Tab
        end)
        
        if #self.Tabs == 0 then
            Tween(TabButton, TweenInfo.new(0.01), {BackgroundColor3 = self.Scheme.Accent})
            self.ActiveTab = Tab
        end
