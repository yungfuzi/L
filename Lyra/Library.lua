...
Library.Templates = {
    Window = { Title = "Lyra", Size = UDim2.fromOffset(560, 420), Center = true, AutoShow = true, Icon = nil, LockResize = true, MinSize = Vector2.new(400, 300) },
    ...
    LinkButton = { Text = "Link", Icon = nil, Callback = function() end },
...
function Library:CreateWindow(info)
    ...
    function Window:AddLinkButton(btnInfo)
        ...
        local Btn = Instance.new("TextButton")
        local textW = GetTextSize(btnInfo.Text or "Link", 12, Enum.Font.Gotham).X
